    ...
    <section className={`game-arena ${isBossCounterAttacking ? 'shake-danger' : ''}`}>
      ...
      <div className="arena-center-info">
        ...
        <button
          ...
          disabled={totalCount === 0 || enemyHp <= 0}
          title={totalCount === 0 ? "Chưa có Task nào để Quyết Đấu!" : enemyHp <= 0 ? "Quái vật đã bị tiêu diệt!" : "Kiểm tra tiến độ tuần. Nếu 100% Done sẽ thắng, nếu chưa sẽ bị phản công!"}
        >
